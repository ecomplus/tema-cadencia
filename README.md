...
> `/segmentos/artigos-esportivos` (Artigos esportivos) já existe em `www.e-com.plus`, na branch
> `feature/beleza`, e aponta para `tema-cadencia.web.app` — que ainda responde
